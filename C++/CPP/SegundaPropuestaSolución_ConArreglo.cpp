...
int main()
{
	...
	while (posicion < 10)
	{
		cout << "Ingrese el numero " << posicion + 1 << ": ";
	...
	cout << "El numero buscado se repitio " << contadorBuscado << " vez/veces." << endl;

	//! Ruta para que el ejecutable exe no se cierre al finalizar.
	cout << "Presiona Enter para reiniciar...";
	cin.ignore();
	cin.get();
	const char *ruta = "C:\\Users\\Aquiles\\Desktop\\GitHub\\Instituto-Superior-de-Formacion\\C++\\CPP\\SegundaPropuestaSolución_ConArreglo.exe";
	system(ruta);
